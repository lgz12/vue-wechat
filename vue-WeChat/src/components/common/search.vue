<template>
       ...
       <div id="search" :class="{'search-open':true}">
    <div class="weui-search-bar" id="search_bar" :class="{'weui-search-bar_focusing':true}">
      <form class="weui-search-bar__form">
        <div class="weui-search-bar__box">
          <i class="weui-icon-search s"></i>
      ...
      <a class="weui-search-bar__cancel-btn" id="search_cancel" v-on:click="$router.push({path:('/')})">取消</a>
    </div>
    <article>
