        ...
        <div class="member">
            ...
            <ul class="chat-dialogue-entry-collect">
                ...
                <li v-for="item in $route.query.msgInfo.user">
                    ...
                    <router-link :to="{path:'/contact/details',query:{wxid:item.wxid,msgInfo:item}}" tag="div" v-if="$route.meta.keepAlive">
                    <img :src="item.headerUrl"></router-link>
...
<script>
    ...
    // },
    activated(){
      this.$store.commit("show","ProjectDetail");
